 ...
 * inner class {@link Properties} describe the behavior how sink table was
 * handled.
 */
public final class SinkConnection extends DataConnection {
  ...
  // constructors
  public SinkConnection() { super(); }

  protected SinkConnection(Builder builder) { super(builder); }
  ...
  public static final class Properties {
    ...
    public static String getPrepareBatchMode() { return PREPARE_BATCH_MODE; }
    ...
    public boolean isAllColumns() { return allColumns; }
    ...
    public static final class Builder {
      ...
      public Properties build() { return new Properties(this); }
    }
  }
}
