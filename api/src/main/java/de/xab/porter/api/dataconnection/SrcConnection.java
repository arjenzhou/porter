 ...
 * inner class {@link Properties} describe the behavior how data was read from
 * source table.
 */
public final class SrcConnection extends DataConnection {
  ...
  // constructors
  public SrcConnection() { super(); }

  protected SrcConnection(Builder builder) { super(builder); }
