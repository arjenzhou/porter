...
public abstract class AbstractWriter implements Writer, Connectable {
  ...
  @Override
  public void write(Object connection, Object dataSource,
                    DataConnection dataConnection, Result<?> data) {
  ...
  protected String getTableIdentifier(SinkConnection sinkConnection) {
    ...
    return quote + sinkConnection.getSchema() + quote + "." + quote +
   ...
   */
  protected abstract void doWrite(DataConnection dataConnection,
                                  Object connection, Result<?> data);
