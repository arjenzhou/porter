...
/**
 * possible state of {@link de.xab.porter.api.Result#sequenceNum}, except
 * positive number that stands sequence number.
 */
public enum SequenceEnum {
  ...
  SequenceEnum(int sequenceNum) { this.sequenceNum = sequenceNum; }
  ...
  public static boolean isFirst(long sequenceNum) {
    return sequenceNum == FIRST.sequenceNum ||
        sequenceNum == FIRST_AND_LAST.sequenceNum;
  }
